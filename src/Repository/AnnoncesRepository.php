...
class AnnoncesRepository extends ServiceEntityRepository
{
    ...
    public function findTopThreeAnnoncesWithBestRatings()
    {
        return $this->createQueryBuilder('a')
            ->select('a.id,a.rooms,a.content,a.introduction,a.slug,a.price,a.coverImage, a.title, AVG(c.note) as note')
